    ...
    <div class="container">
        <div id="content" class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
            <div data-book-id="22" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/22"><img src="/assets/books-page/books-page_files/22.jpg" alt="СИ++ И КОМПЬЮТЕРНАЯ ГРАФИКА">
                        <div data-title="СИ++ И КОМПЬЮТЕРНАЯ ГРАФИКА" class="blockI" style="height: 46px;">
                            <div data-book-title="СИ++ И КОМПЬЮТЕРНАЯ ГРАФИКА" class="title size_text">СИ++ И КОМПЬЮТЕРНАЯ ГРАФИКА</div>
            ...
            <div data-book-id="23" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/23"><img src="books-page_files/23.jpg" alt="Программирование на языке Go!">
            ...
            <div data-book-id="25" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/25"><img src="books-page_files/25.jpg" alt="Толковый словарь сетевых терминов и аббревиатур">
            ...
            <div data-book-id="26" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/26"><img src="books-page_files/26.jpg" alt="Python for Data Analysis">
            ...
            <div data-book-id="27" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/27"><img src="books-page_files/27.jpg" alt="Thinking in Java (4th Edition)">
            ...
            <div data-book-id="29" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/29"><img src="books-page_files/29.jpg" alt="Introduction to Algorithms">
            ...
            <div data-book-id="31" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/31"><img src="books-page_files/31.jpg" alt="JavaScript Pocket Reference">
            ...
            <div data-book-id="32" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/32"><img src="books-page_files/32.jpg" alt="Adaptive Code via C#: Class and Interface Design, Design Patterns, and SOLID Principles">
            ...
            <div data-book-id="33" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/33"><img src="books-page_files/33.jpg" alt="SQL: The Complete Referenc">
            ...
            <div data-book-id="34" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/34"><img src="books-page_files/34.jpg" alt="PHP and MySQL Web Development">
            ...
            <div data-book-id="35" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/35"><img src="books-page_files/35.jpg" alt="Статистический анализ и визуализация данных с помощью R">
            ...
            <div data-book-id="36" class="book_item col-xs-6 col-sm-3 col-md-2 col-lg-2">
                <div class="book">
                    <a href="http://localhost:3000/book/36"><img src="books-page_files/36.jpg" alt="Computer Coding for Kid">
