        ...
        <div id="content" class="book_block col-xs-12 col-sm-12 col-md-12 col-lg-12">
            ...
            <div id="id" book-id="{{ $book['id'] }}">
                <div id="bookImg" class="col-xs-12 col-sm-3 col-md-3 item">
                    <img src="/assets/books-preview/{{ $book['preview'] }}" alt="Responsive image" class="img-responsive">

                    <hr>
                </div>
                <div class="col-xs-12 col-sm-9 col-md-9 col-lg-9 info">
                    <div class="bookInfo col-md-12">
                        <div id="title" class="titleBook">{{ $book['book'] }}</div>
                    </div>
                    ...
                    <div class="btnBlock col-xs-12 col-sm-12 col-md-12">
                        <button type="button" id="btnWant-{{ $book['id'] }}" class="btnBookID btn-lg btn btn-success">Хочу читать!</button>
                    </div>
